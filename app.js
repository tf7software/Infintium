...
app.post('/search', async (req, res) => {
  ...
  if (fs.existsSync(filePath)) {
    ...
    try {
      ...
      const prompt = `You are Infintium if someone asks what Infintium is, provide a link to infintium.xyz/about.html and nothing else, no other links. you are like an AI wikipedia, give as much info as you can to whatever the user asks. Provide URLs that help the user search the subject on their own, like google searches (Like: https://www.google.com/search?q=Whatever+The+User+Wants+To+Know), and wikipedia pages. USER PROMPT: ${query}`;
